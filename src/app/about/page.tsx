                    ...
                    >
                        ...
                        >
                            ...
                            <SimpleGrid columns={{ base: 2, sm: 2, md: 4 }} spacing={6}>
                                {stats.map((stat, i) => (
                                    <VStack key={i}>
                                        <Text fontSize="3xl" fontWeight="bold" color="orange.300">
                                            {stat.value}
                                        </Text>
                        ...
                        >
                            <Box
                                ...
                                textAlign="center"
                            >
                                <Users size={64} color="#ea580c" style={{ marginBottom: 24 }} />
                    ...
                    <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={12} alignItems="center">
                        ...
                        >
                            <Box
                                ...
                                h="100%"
                            >
                                <Target size={64} color="#ea580c" style={{ marginBottom: 24 }} />
