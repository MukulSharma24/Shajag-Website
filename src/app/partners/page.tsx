...
const partners = [
    ...
    {
        name: "Fortinet",
        logo: "/partner/fortinet-logo.svg",
        description:
            "Elite Fortinet partner delivering enterprise-grade cybersecurity solutions, network security, and threat protection services.",
...
export default function Partners() {
    return (
        <Box pt={{ base: 20, md: 24 }}>
            ...
            {/* Partners Grid */}
            <Box as="section" py={{ base: 12, md: 20 }} pt={24} bg="gray.50">
                <Container maxW="7xl">
